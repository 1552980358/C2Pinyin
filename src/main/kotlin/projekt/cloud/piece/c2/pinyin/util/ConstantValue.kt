...
object ConstantValue {
    ...
    internal  const val PINYIN_12295 = "LING"

    internal const val CHAR_12295 = 12295.toChar()

    internal const val CODING_OFFSET_A = 7000

    internal const val CODING_OFFSET_B = 14000

    internal val BIT_MASKS = intArrayOf(1, 2, 4, 8, 16, 32, 64, 128)

    internal const val PADDING_MASK = 256

    internal  val PINYIN = arrayOf(
